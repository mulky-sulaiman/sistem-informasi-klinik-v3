...
class ClinicPolicy
{
    ...
    {
        return $user->hasPermission('view_any_clinic');
    }
    ...
    {
        return $user->hasPermission('view_clinic');
    }
    ...
    {
        return $user->hasPermission('update_clinic');
    }
    ...
    {
        return $user->hasPermission('delete_any_clinic');
    }
    ...
    {
        return $user->hasPermission('delete_clinic');
    }
}
