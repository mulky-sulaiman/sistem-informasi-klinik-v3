...
class TreatmentCategoryPolicy
{
    ...
    {
        return $user->hasPermission('view_any_treatment_category');
    }
    ...
    {
        return $user->hasPermission('view_treatment_category');
    }
    ...
    {
        return $user->hasPermission('create_treatment_category');
    }
    ...
    {
        return $user->hasPermission('update_treatment_category');
    }
    ...
    {
        return $user->hasPermission('delete_any_treatment_category');
    }
    ...
    {
        return $user->hasPermission('delete_treatment_category');
    }
}
